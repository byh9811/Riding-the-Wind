    ...
    <div class='container text-center'>
        <section class="py-5 container ">
            <div class="row py-lg-5"
                 style='background-image: url(./asset/img/trip_img_main.jpg); background-size: cover; border-radius: 10px;'>
        ...
        <div class='container row row-cols-1 row-cols-sm-2 row-cols-md-4'
            ...
            <div class="card col" style="width: 18rem;">
                <img src="${root}/asset/img/Haeundae.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card col" style="width: 18rem;">
                <img src="./asset/img/Juju.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card col" style="width: 18rem;">
                <img src="./asset/img/Tongyung.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card col" style="width: 18rem;">
                <img src="./asset/img/Gwangju.jpg" class="card-img-top" alt="...">
                <div class="card-body">
